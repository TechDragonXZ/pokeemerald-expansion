...
static const struct SignatureZMove sSignatureZMoves[] =
{
    ...
    // Custom
    {SPECIES_ARCEUS_BUG,              ITEM_BUGINIUM_Z,           MOVE_JUDGMENT,            MOVE_SUPREME_JUDGMENT},
    {SPECIES_ARCEUS_DARK,             ITEM_DARKINIUM_Z,          MOVE_JUDGMENT,            MOVE_SUPREME_JUDGMENT},
    {SPECIES_ARCEUS_DRAGON,           ITEM_DRAGONIUM_Z,          MOVE_JUDGMENT,            MOVE_SUPREME_JUDGMENT},
    {SPECIES_ARCEUS_ELECTRIC,         ITEM_ELECTRIUM_Z,          MOVE_JUDGMENT,            MOVE_SUPREME_JUDGMENT},
    {SPECIES_ARCEUS_FAIRY,            ITEM_FAIRIUM_Z,            MOVE_JUDGMENT,            MOVE_SUPREME_JUDGMENT},
    {SPECIES_ARCEUS_FIGHTING,         ITEM_FIGHTINIUM_Z,         MOVE_JUDGMENT,            MOVE_SUPREME_JUDGMENT},
    {SPECIES_ARCEUS_FIRE,             ITEM_FIRIUM_Z,             MOVE_JUDGMENT,            MOVE_SUPREME_JUDGMENT},
    {SPECIES_ARCEUS_FLYING,           ITEM_FLYINIUM_Z,           MOVE_JUDGMENT,            MOVE_SUPREME_JUDGMENT},
    {SPECIES_ARCEUS_GHOST,            ITEM_GHOSTIUM_Z,           MOVE_JUDGMENT,            MOVE_SUPREME_JUDGMENT},
    {SPECIES_ARCEUS_GRASS,            ITEM_GRASSIUM_Z,           MOVE_JUDGMENT,            MOVE_SUPREME_JUDGMENT},
    {SPECIES_ARCEUS_GROUND,           ITEM_GROUNDIUM_Z,          MOVE_JUDGMENT,            MOVE_SUPREME_JUDGMENT},
    {SPECIES_ARCEUS_ICE,              ITEM_ICIUM_Z,              MOVE_JUDGMENT,            MOVE_SUPREME_JUDGMENT},
    {SPECIES_ARCEUS_NORMAL,           ITEM_NORMALIUM_Z,          MOVE_JUDGMENT,            MOVE_SUPREME_JUDGMENT},
    {SPECIES_ARCEUS_POISON,           ITEM_POISONIUM_Z,          MOVE_JUDGMENT,            MOVE_SUPREME_JUDGMENT},
    {SPECIES_ARCEUS_PSYCHIC,          ITEM_PSYCHIUM_Z,           MOVE_JUDGMENT,            MOVE_SUPREME_JUDGMENT},
    {SPECIES_ARCEUS_ROCK,             ITEM_ROCKIUM_Z,            MOVE_JUDGMENT,            MOVE_SUPREME_JUDGMENT},
    {SPECIES_ARCEUS_STEEL,            ITEM_STEELIUM_Z,           MOVE_JUDGMENT,            MOVE_SUPREME_JUDGMENT},
    {SPECIES_ARCEUS_WATER,            ITEM_WATERIUM_Z,           MOVE_JUDGMENT,            MOVE_SUPREME_JUDGMENT},
};

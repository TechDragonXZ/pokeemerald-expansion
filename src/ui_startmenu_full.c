...
#define CLOCK_MODE_FLAG FLAG_CLOCK_MODE
...
#if (CLOCK_MODE_FLAG != 0)
    if (FlagGet(CLOCK_MODE_FLAG)) // true: 12-hours, false: 24-hours
    {
...
static void Task_StartMenuFullMain(u8 taskId)
{
    ...
    {
        if (FlagGet(CLOCK_MODE_FLAG))
            FlagClear(CLOCK_MODE_FLAG);
        else
            FlagSet(CLOCK_MODE_FLAG);

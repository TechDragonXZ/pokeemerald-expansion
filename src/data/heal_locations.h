static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_METEOR_FALLS_PEAK - 1] = {MAP_GROUP(METEOR_FALLS_PEAK), MAP_NUM(METEOR_FALLS_PEAK), 7, 12},
    [HEAL_LOCATION_AEROWAY_ISLAND - 1] = {MAP_GROUP(AEROWAY_ISLAND), MAP_NUM(AEROWAY_ISLAND), 33, 24},
};

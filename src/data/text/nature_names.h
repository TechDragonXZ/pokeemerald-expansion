...
static const u8 sPridefulNatureName[] _("Prideful");
static const u8 sLowlyNatureName[] _("Lowly");
...
const u8 *const gNatureNamePointers[NUM_NATURES] =
{
    ...
    [NATURE_PRIDEFUL] = sPridefulNatureName,
    [NATURE_LOWLY] = sLowlyNatureName,
};

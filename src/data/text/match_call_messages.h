...
const u8 gText_MatchCallBlackBelt_Nob_Pokemon[] = _("Fightning type.");
...
const u8 gText_MatchCallExpert_Timothy_Pokemon[] = _("The essence of Fightning.");
...
const u8 gText_MatchCallExpert_Shelby_Pokemon[] = _("The Fightning type.");
...
const u8 gText_MatchCallBattleGirl_Cyndy_Pokemon[] = _("Speedy Fightning type.");
...
const u8 gText_MatchCallSailor_Ernest_Pokemon[] = _("Water and Fightning types.");
...
const u8 gText_MatchCallTheBigHit_Brawly_Pokemon[] = _("Fightning Pokémon rule!");

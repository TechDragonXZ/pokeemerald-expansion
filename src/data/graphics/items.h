...
const u32 gItemIcon_ChargedMeteorite[] = INCBIN_U32("graphics/items/icons/meteorite.4bpp.lz");
const u32 gItemIconPalette_ChargedMeteorite[] = INCBIN_U32("graphics/items/icon_palettes/meteorite.gbapal.lz");

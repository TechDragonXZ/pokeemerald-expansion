const struct BattleMove gBattleMoves[MOVES_COUNT_Z] =
{
    ...
    [MOVE_DISASTER_WARN] =
    {
        ...
        .target = MOVE_TARGET_SELECTED,
        .priority = 2,
        .flags = FLAG_MAKES_CONTACT | FLAG_PROTECT_AFFECTED | FLAG_MIRROR_MOVE_AFFECTED | FLAG_KINGS_ROCK_AFFECTED | FLAG_DMG_MINIMIZE | FLAG_HIGH_CRIT | FLAG_SLICING_MOVE | FLAG_DMG_IN_AIR | FLAG_DMG_UNDERGROUND | FLAG_DMG_UNDERWATER | FLAG_DMG_UNGROUNDED_IGNORE_TYPE_IF_FLYING,
        .split = SPLIT_PHYSICAL,
        .argument = TYPE_FAIRY,
        .zMoveEffect = Z_EFFECT_NONE,
    },

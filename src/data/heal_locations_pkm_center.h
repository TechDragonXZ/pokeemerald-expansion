...
static const struct HealLocation sHealLocationsPokemonCenter[NUM_HEAL_LOCATIONS - 1] =
{
    ...
    [HEAL_LOCATION_DRACON_HARBOR_EXTERIOR - 1] =
    {
        .mapGroup = MAP_GROUP(MAP_DRACON_HARBOR_EXTERIOR),
        .mapNum = MAP_NUM(MAP_DRACON_HARBOR_EXTERIOR),
        .x = 6,
        .y = 2,
    },
};
...
static const u8 sHealNpcLocalId[NUM_HEAL_LOCATIONS - 1] =
{
    ...
    [HEAL_LOCATION_DRACON_HARBOR_EXTERIOR - 1] = 0,
};

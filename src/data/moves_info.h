...
const struct MoveInfo gMovesInfo[MOVES_COUNT_DYNAMAX] =
{
    ...
    [MOVE_DRACO_SWARM] =
    {
        .name = COMPOUND_STRING("Draco Swarm"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_DISASTER_WARN] =
    {
        .name = COMPOUND_STRING("Disaster Warn"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_INNER_POWER] =
    {
        .name = COMPOUND_STRING("Inner Power"),
        .description = COMPOUND_STRING(
            "The effectiveness varies\n"
            "with the user."),
        .effect = EFFECT_HIDDEN_POWER,
    ...
    [MOVE_FINAL_STRIKE] =
    {
        .name = COMPOUND_STRING("Final Strike"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_DELTA_ENERGY] =
    {
        .name = COMPOUND_STRING("Delta Energy"),
        .description = COMPOUND_STRING(
            "This move is super effective\n"
            "against multiple types."),
        .effect = EFFECT_DELTA_ENERGY,
        .power = 90,
        .type = TYPE_NORMAL,
        .accuracy = 100,
        .pp = 10,

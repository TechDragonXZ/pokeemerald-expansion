...
// Custom Moves
    ...
    [MOVE_BEAM_BASH] =
    {
        .name = COMPOUND_STRING("Beam Bash"),
        .description = COMPOUND_STRING(
            "This move's types varies\n"
            "with the user."),
        .effect = EFFECT_BEAM_BASH,
        .power = 75,
        .type = TYPE_NORMAL,
        .argument = TYPE_FIGHTING,
        .accuracy = 100,
    ...
    [MOVE_FROSTBURN] =
    {
        .name = COMPOUND_STRING("Frostburn"),
        .description = COMPOUND_STRING(
            "Fires a super cold ice beam.\n"
        #if B_USE_FROSTBITE == TRUE
            "May cause frostbite or burn."),
        #else
            "May cause freeze or burn."),
        #endif
        .effect = EFFECT_TWO_TYPED_MOVE,
        .power = 75,
        .type = TYPE_ICE,
        ...
        .priority = 0,
        .additionalEffects = ADDITIONAL_EFFECTS({
            .moveEffect = MOVE_EFFECT_FROSTBURN,
            .chance = 50,
        }),
        .category = DAMAGE_CATEGORY_SPECIAL,
        .contestEffect = CONTEST_EFFECT_HIGHLY_APPEALING,
    ...
    [MOVE_MELT] =
    {
        .name = COMPOUND_STRING("Melt"),
        .description = COMPOUND_STRING(
            "Uses intense heat to\n"
            "make Ice-type, Water-type."),
        .effect = EFFECT_MELT,
        .power = 0,
        .type = TYPE_FIRE,
        .accuracy = 100,
    ...
    [MOVE_CORROSION] =
    {
        .name = COMPOUND_STRING("Corrosion"),
        .description = COMPOUND_STRING(

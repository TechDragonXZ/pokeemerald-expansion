...
static const struct MenuAction MultichoiceList_VendingMachinePokeball[] =
{
    ...
    {gText_SportBallAndPrice},
    {gText_ParkBallAndPrice},
    {gText_Exit},
};
...
static const struct MultichoiceListStruct sMultichoiceLists[] =
{
    ...
    [MULTI_ALTERING_CAVE_ENCOUNTERS_PAGE2]   = MULTICHOICE(MultichoiceList_AlteringCave2),
    [MULTI_ALTERING_CAVE_ENCOUNTERS_PAGE3]   = MULTICHOICE(MultichoiceList_AlteringCave3),

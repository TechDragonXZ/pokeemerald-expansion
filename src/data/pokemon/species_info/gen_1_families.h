...
#define PIDGEOT_SPEED (P_UPDATED_STATS >= GEN_6 ? 101 : 91)
    ...
    [SPECIES_PIKACHU] =
    {
        ...
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_RAICHU},
                                {EVO_ITEM_HOLD, ITEM_BIG_MALASADA, SPECIES_RAICHU_ALOLAN}),
    },
...
#define FARFETCHD_ATTACK (P_UPDATED_STATS >= GEN_7 ? 90 : 65)
    ...
    [SPECIES_GASTLY] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_LEVITATE, ABILITY_SCARE, ABILITY_CURSED_BODY },
        .bodyColor = BODY_COLOR_PURPLE,
...
#define GENGAR_ABILITIES {ABILITY_CURSED_BODY, ABILITY_SCARE, ABILITY_LEVITATE}
#else
#define GENGAR_ABILITIES {ABILITY_LEVITATE, ABILITY_SCARE, ABILITY_CURSED_BODY}
#endif
    ...
    [SPECIES_EXEGGCUTE] =
    {
        ...
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_LEAF_STONE, SPECIES_EXEGGUTOR},
                                {EVO_ITEM_HOLD, ITEM_BIG_MALASADA, SPECIES_EXEGGUTOR_ALOLAN}),
    },
...
#define EXEGGUTOR_SP_DEF (P_UPDATED_STATS >= GEN_7 ? 75 : 65)
    ...
    [SPECIES_KOFFING] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 35, SPECIES_WEEZING},
                                {EVO_MOVE, MOVE_FAIRY_WIND, SPECIES_WEEZING_GALARIAN}),
    },
    ...
    [SPECIES_MIME_JR] =
    {
        ...
        .evolutions = EVOLUTION({EVO_MOVE, MOVE_MIMIC, SPECIES_MR_MIME},
                                {EVO_USE_MOVE_TWENTY_TIMES, MOVE_ICY_WIND, SPECIES_MR_MIME_GALARIAN}),
    },
#endif //P_GEN_4_CROSS_EVOS
    ...
    [SPECIES_EEVEE_PARTNER] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_UNSTABLE_GENES, ABILITY_UNSTABLE_GENES, ABILITY_UNSTABLE_GENES },
        .bodyColor = BODY_COLOR_BROWN,
        .speciesName = _("Eevee"),
        .cryId = CRY_EEVEE,
        .natDexNum = NATIONAL_DEX_EEVEE,

...
#endif
    {FORM_CHANGE_ITEM_HOLD, SPECIES_CASTFORM_SUNNY,  ITEM_HEAT_ROCK,   ABILITY_FORECAST},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_CASTFORM_RAINY,  ITEM_DAMP_ROCK,   ABILITY_FORECAST},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_CASTFORM_SNOWY,  ITEM_ICY_ROCK,    ABILITY_FORECAST},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_CASTFORM_SANDY,  ITEM_SMOOTH_ROCK, ABILITY_FORECAST},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_CASTFORM_NORMAL, ITEM_NONE, ABILITY_FORECAST},

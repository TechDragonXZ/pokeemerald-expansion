...
static const struct FormChange sCastformFormChangeTable[] = {
    ...
    {FORM_CHANGE_BATTLE_WEATHER,                SPECIES_CASTFORM_NORMAL, ~(B_WEATHER_SUN | B_WEATHER_RAIN | B_WEATHER_HAIL | B_WEATHER_SNOW | B_WEATHER_SANDSTORM | B_WEATHER_STRONG_WINDS), ABILITY_FORECAST},
    ...
    {FORM_CHANGE_BATTLE_WEATHER,                SPECIES_CASTFORM_NORMAL, ~(B_WEATHER_SUN | B_WEATHER_RAIN | B_WEATHER_HAIL | B_WEATHER_SNOW | B_WEATHER_SANDSTORM | B_WEATHER_STRONG_WINDS)},
...
static const struct FormChange sAegislashFormChangeTable[] = {
    ...
    {FORM_CHANGE_BATTLE_BEFORE_MOVE,          SPECIES_AEGISLASH_BLADE,  MOVE_KINGS_BLADE,         ABILITY_STANCE_CHANGE},
    {FORM_CHANGE_BATTLE_BEFORE_MOVE,          SPECIES_AEGISLASH_SHIELD, MOVE_KINGS_SHIELD,        ABILITY_STANCE_CHANGE},
    {FORM_CHANGE_BATTLE_BEFORE_MOVE_CATEGORY, SPECIES_AEGISLASH_BLADE,  DAMAGE_CATEGORY_PHYSICAL, ABILITY_GHOSTLY_BLADE},
    {FORM_CHANGE_BATTLE_BEFORE_MOVE_CATEGORY, SPECIES_AEGISLASH_BLADE,  DAMAGE_CATEGORY_SPECIAL,  ABILITY_GHOSTLY_BLADE},
    {FORM_CHANGE_BATTLE_BEFORE_MOVE,          SPECIES_AEGISLASH_BLADE,  MOVE_KINGS_BLADE,         ABILITY_GHOSTLY_BLADE},
    {FORM_CHANGE_BATTLE_BEFORE_MOVE,          SPECIES_AEGISLASH_SHIELD, MOVE_KINGS_SHIELD,        ABILITY_GHOSTLY_BLADE},

const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_PIKACHU]               = {{EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_RAICHU},
                                       {EVO_SPECIFIC_MAP, MAP_DEEP_PETALBURG_WOODS, SPECIES_RAICHU_ALOLAN},
    ...
    [SPECIES_EXEGGCUTE]             = {{EVO_ITEM, ITEM_LEAF_STONE, SPECIES_EXEGGUTOR},
                                       {EVO_SPECIFIC_MAP, MAP_DEEP_PETALBURG_WOODS, SPECIES_EXEGGUTOR_ALOLAN}},
    [SPECIES_CUBONE]                = {{EVO_LEVEL, 28, SPECIES_MAROWAK},
                                       {EVO_SPECIFIC_MAP, MAP_DEEP_PETALBURG_WOODS, SPECIES_MAROWAK_ALOLAN}},
#if P_GEN_4_POKEMON == TRUE
    [SPECIES_LICKITUNG]             = {{EVO_MOVE, MOVE_ROLLOUT, SPECIES_LICKILICKY}},
#endif
    [SPECIES_KOFFING]               = {{EVO_LEVEL, 35, SPECIES_WEEZING},
                                       {EVO_SPECIFIC_MAP, MAP_DEEP_PETALBURG_WOODS, SPECIES_WEEZING_GALARIAN}},
    ...
    [SPECIES_QUILAVA]               = {{EVO_LEVEL, 36, SPECIES_TYPHLOSION},
                                       {EVO_SPECIFIC_MAP, MAP_DEEP_PETALBURG_WOODS, SPECIES_TYPHLOSION_HISUIAN}},
    ...
    [SPECIES_MIME_JR]               = {{EVO_MOVE, MOVE_MIMIC, SPECIES_MR_MIME},
                                       {EVO_SPECIFIC_MAP, MAP_DEEP_PETALBURG_WOODS, SPECIES_MR_MIME_GALARIAN}},
    ...
    [SPECIES_DEWOTT]                = {{EVO_LEVEL, 36, SPECIES_SAMUROTT},
                                       {EVO_SPECIFIC_MAP, MAP_DEEP_PETALBURG_WOODS, SPECIES_SAMUROTT_HISUIAN}},
    ...
    [SPECIES_RUFFLET]               = {{EVO_LEVEL, 54, SPECIES_BRAVIARY},
                                       {EVO_LEVEL_PSY_TYPE_MON_IN_PARTY, 54, SPECIES_BRAVIARY_HISUIAN}},
    ...
    [SPECIES_FROGADIER]             = {{EVO_LEVEL, 36, SPECIES_GRENINJA},
                                        {EVO_CRITICAL_HITS, 3, SPECIES_GRENINJA_BATTLE_BOND}},
    ...
    [SPECIES_GOOMY]                 = {{EVO_LEVEL, 40, SPECIES_SLIGGOO},
                                       {EVO_SPECIFIC_MAP, MAP_DEEP_PETALBURG_WOODS, SPECIES_SLIGGOO_HISUIAN}},
    ...
    [SPECIES_BERGMITE]              = {{EVO_LEVEL, 37, SPECIES_AVALUGG},
                                       {EVO_SPECIFIC_MAP, MAP_DEEP_PETALBURG_WOODS, SPECIES_AVALUGG_HISUIAN}},
    ...
    [SPECIES_DARTRIX]               = {{EVO_LEVEL, 34, SPECIES_DECIDUEYE},
                                       {EVO_SPECIFIC_MAP, MAP_DEEP_PETALBURG_WOODS, SPECIES_DECIDUEYE_HISUIAN}},

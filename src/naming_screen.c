...
static void (*const sDrawTextEntryBoxFuncs[])(void) =
{
    ...
    [NAMING_SCREEN_NUMBERS]    = DrawNormalTextEntryBox,
};
...
static const struct NamingScreenTemplate sNumberCodeScreenTemplate = 
{
    .copyExistingString = FALSE,
    .maxChars = NUMBER_CODE_NAME_LENGTH,
    .iconFunction = 5,
    .addGenderIcon = FALSE,
    .initialPage = KBPAGE_LETTERS_UPPER,
    .unused = 35,
...
static const struct NamingScreenTemplate *const sNamingScreenTemplates[] =
{
    ...
    [NAMING_SCREEN_NUMBERS]    = &sNumberCodeScreenTemplate,
};

...
//  {ITEM_1,            ITEM_2,               ITEM_3,                ITEM_4,             |||| CRAFT_PRODUCT,       QUANTITY},
    // Restoration
    {0,                 0,                    ITEM_PECHA_BERRY,      ITEM_MEDICINAL_LEEK,     ITEM_ANTIDOTE,       2},
    {0,                 0,                    ITEM_CHESTO_BERRY,     ITEM_MEDICINAL_LEEK,     ITEM_AWAKENING,      2},
    {0,                 0,                    ITEM_RAWST_BERRY,      ITEM_MEDICINAL_LEEK,     ITEM_BURN_HEAL,      2},
    {0,                 0,                    ITEM_ASPEAR_BERRY,     ITEM_MEDICINAL_LEEK,     ITEM_ICE_HEAL,       2},
    {0,                 0,                    ITEM_CHERI_BERRY,      ITEM_MEDICINAL_LEEK,     ITEM_PARALYZE_HEAL,  2},
    {ITEM_CHERI_BERRY,  ITEM_PECHA_BERRY,     ITEM_RAWST_BERRY,      ITEM_ASPEAR_BERRY,       ITEM_FULL_HEAL,      2},
    {0,                 ITEM_LEPPA_BERRY,     ITEM_PEPUP_PLANT,      ITEM_PEPUP_PLANT,        ITEM_MAX_ETHER,      2},
    {0,                 ITEM_MAX_ETHER,       ITEM_PEPUP_PLANT,      ITEM_PEPUP_PLANT,        ITEM_MAX_ELIXIR,     2},
    // Medicine
    {0,                 0,                    ITEM_ORAN_BERRY,       ITEM_MEDICINAL_LEEK,     ITEM_POTION,         2},
    {0,                 0,                    ITEM_POTION,           ITEM_PEPUP_PLANT,        ITEM_SUPER_POTION,   2},
    {0,                 0,                    ITEM_SUPER_POTION,     ITEM_VIVICHOKE,          ITEM_HYPER_POTION,   2},
    {0,                 0,                    ITEM_SITRUS_BERRY,     ITEM_KING_LEAF,          ITEM_MAX_POTION,     2},
    {0,                 0,                    ITEM_MAX_POTION,       ITEM_FULL_HEAL,          ITEM_FULL_RESTORE,   2},
    {0,                 ITEM_MEDICINAL_LEEK,  ITEM_MEDICINAL_LEEK,   ITEM_VIVICHOKE,          ITEM_REVIVE,         2},
    {0,                 ITEM_REVIVE,          ITEM_KING_LEAF,        ITEM_KING_LEAF,          ITEM_MAX_REVIVE,     2},
    {0,                 0,                    ITEM_BUGWORT,          ITEM_BUGWORT,            ITEM_REMEDY,         2},
    {0,                 0,                    ITEM_REMEDY,           ITEM_PEPUP_PLANT,        ITEM_FINE_REMEDY,    2},
    {0,                 0,                    ITEM_FINE_REMEDY,      ITEM_VIVICHOKE,          ITEM_SUPERB_REMEDY,  2},
    // Battle
    {0,                 ITEM_SWORDCAP,        ITEM_SWORDCAP,        ITEM_PEPUP_PLANT,         ITEM_AUX_POWER,      2},
    {0,                 ITEM_IRON_BARKTONGUE, ITEM_IRON_BARKTONGUE, ITEM_PEPUP_PLANT,         ITEM_AUX_GUARD,      2},
    {0,                 ITEM_AUX_GUARD,       ITEM_AUX_POWER,       ITEM_KING_LEAF,           ITEM_AUX_POWERGUARD, 2},
    {0,                 ITEM_CANDY_TRUFFLE,   ITEM_DOPPEL_BONNETS,  ITEM_DOPPEL_BONNETS,      ITEM_AUX_EVASION,    2},
    {0,                 ITEM_CANDY_TRUFFLE,   ITEM_DIRESHROOM,      ITEM_DIRESHROOM,          ITEM_DIRE_HIT,       2},
    // Overworld
    {ITEM_HOPO_BERRY,   ITEM_BUGWORT,         ITEM_BUGWORT,         ITEM_BUGWORT,             ITEM_REPEL,          2},
    {0,                 ITEM_REPEL,           ITEM_REPEL,           ITEM_PEPUP_PLANT,         ITEM_SUPER_REPEL,    2},
    {0,                 ITEM_SUPER_REPEL,     ITEM_SUPER_REPEL,     ITEM_SUPER_REPEL,         ITEM_MAX_REPEL,      2},
    {0,                 ITEM_HONEY,           ITEM_HONEY,           ITEM_HONEY,               ITEM_LURE,           2},
    {0,                 ITEM_LURE,            ITEM_LURE,            ITEM_PEPUP_PLANT,         ITEM_SUPER_LURE,     2},
    {0,                 ITEM_SUPER_LURE,      ITEM_SUPER_LURE,      ITEM_SUPER_LURE,          ITEM_MAX_LURE,       2},
    // Pokéballs
    {0,                 0,                    ITEM_RED_APRICORN,    ITEM_IRON_CHUNK,          ITEM_LEVEL_BALL,     1},
    {0,                 0,                    ITEM_YELLOW_APRICORN, ITEM_IRON_CHUNK,          ITEM_MOON_BALL,      1},
    {0,                 0,                    ITEM_BLUE_APRICORN,   ITEM_IRON_CHUNK,          ITEM_LURE_BALL,      1},
    {0,                 0,                    ITEM_GREEN_APRICORN,  ITEM_IRON_CHUNK,          ITEM_FRIEND_BALL,    1},
    {0,                 0,                    ITEM_PINK_APRICORN,   ITEM_IRON_CHUNK,          ITEM_LOVE_BALL,      1},
    {0,                 0,                    ITEM_WHITE_APRICORN,  ITEM_IRON_CHUNK,          ITEM_FAST_BALL,      1},
    {0,                 0,                    ITEM_BLACK_APRICORN,  ITEM_IRON_CHUNK,          ITEM_HEAVY_BALL,     1},
    // Misc
    {ITEM_STARDUST,     ITEM_RED_SHARD,       ITEM_BLUE_SHARD,      ITEM_GREEN_SHARD,         ITEM_STAR_PIECE,     1},
    {ITEM_EXP_CANDY_XS, ITEM_EXP_CANDY_XS,    ITEM_EXP_CANDY_XS,    ITEM_EXP_CANDY_XS,        ITEM_EXP_CANDY_S,    2},
    {ITEM_EXP_CANDY_S,  ITEM_EXP_CANDY_S,     ITEM_EXP_CANDY_S,     ITEM_EXP_CANDY_S,         ITEM_EXP_CANDY_M,    2},
    {ITEM_EXP_CANDY_M,  ITEM_EXP_CANDY_M,     ITEM_EXP_CANDY_M,     ITEM_EXP_CANDY_M,         ITEM_EXP_CANDY_L,    2},
    {ITEM_EXP_CANDY_L,  ITEM_EXP_CANDY_L,     ITEM_EXP_CANDY_L,     ITEM_EXP_CANDY_L,         ITEM_EXP_CANDY_XL,   2},
    {ITEM_EXP_CANDY_S,  ITEM_EXP_CANDY_M,     ITEM_EXP_CANDY_L,     ITEM_CANDY_TRUFFLE,       ITEM_RARE_CANDY,     4},
    {ITEM_MAX_HONEY,    ITEM_MAX_MUSHROOMS,   ITEM_MAX_MUSHROOMS,   ITEM_CANDY_TRUFFLE,       ITEM_DYNAMAX_CANDY,  2},
};
...
//  {CRAFT PRODUCT,   |||| FLAG 1,                      FLAG 2,  FLAG 3},
    {ITEM_LEVEL_BALL,      FLAG_APRICORN_BALLS_RECIPES, NO_FLAG, NO_FLAG},
    {ITEM_MOON_BALL,       FLAG_APRICORN_BALLS_RECIPES, NO_FLAG, NO_FLAG},
    {ITEM_LURE_BALL,       FLAG_APRICORN_BALLS_RECIPES, NO_FLAG, NO_FLAG},
    {ITEM_FRIEND_BALL,     FLAG_APRICORN_BALLS_RECIPES, NO_FLAG, NO_FLAG},
    {ITEM_LOVE_BALL,       FLAG_APRICORN_BALLS_RECIPES, NO_FLAG, NO_FLAG},
    {ITEM_FAST_BALL,       FLAG_APRICORN_BALLS_RECIPES, NO_FLAG, NO_FLAG},
    {ITEM_HEAVY_BALL,      FLAG_APRICORN_BALLS_RECIPES, NO_FLAG, NO_FLAG}
};
...
static void BuildCraftTableActions(void){
    ...
    for (i = 0; i < 4; i++){
        if(sCurrentCraftTableItems[i][CRAFT_TABLE_ITEM] == ITEM_NONE ||
            sCurrentCraftTableItems[i][CRAFT_TABLE_ITEM] > ITEMS_COUNT){
...
static void UpdateCraftInfoWindow(void){
    ...
    if (itemId){
        ...
        //icon
        ShowItemIconSpriteMenu(itemId, handleFlash, 184, 140); //176 = tilemapleft + 16 border pixels, 140 from GhoulSlash
...
static bool8 HandleCraftMenuInput(void){
    ...
    return FALSE;  // Default return statement to fix "control reaches end of non-void function" error.
}
...
static void InitItemSprites(void){
    ...
    ShowItemIconSpriteMenu(ITEM_PECHA_BERRY,FALSE,200,1);
    DestroyItemIconSpriteMenu();
}

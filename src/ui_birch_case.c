...
{
    [BALL_TOP_FIRST]        = {SPECIES_EEVEE, 5, ITEM_FIRE_GEM, BALL_CHERISH, NATURE_JOLLY, 0, MON_MALE, {0, 0, 0, 0, 0, 0}, {31, 31, 31, 31, 31, 31}, {MOVE_TACKLE, MOVE_GROWL, MOVE_TAIL_WHIP, MOVE_EMBER}, TRUE, TYPE_GHOST, FALSE}, // Fire
    [BALL_TOP_SECOND]       = {SPECIES_EEVEE, 5, ITEM_WATER_GEM, BALL_CHERISH, NATURE_JOLLY, 0, MON_MALE, {0, 0, 0, 0, 0, 0}, {31, 31, 31, 31, 31, 31}, {MOVE_TACKLE, MOVE_GROWL, MOVE_TAIL_WHIP, MOVE_WATER_GUN}, TRUE, TYPE_GHOST, FALSE}, // Water
    [BALL_MIDDLE_FIRST]     = {SPECIES_EEVEE, 5, ITEM_PSYCHIC_GEM, BALL_CHERISH, NATURE_JOLLY, 0, MON_MALE, {0, 0, 0, 0, 0, 0}, {31, 31, 31, 31, 31, 31}, {MOVE_TACKLE, MOVE_GROWL, MOVE_TAIL_WHIP, MOVE_CONFUSION}, TRUE, TYPE_GHOST, FALSE}, // Psychic

    [BALL_TOP_THIRD]        = {SPECIES_EEVEE, 5, ITEM_ELECTRIC_GEM, BALL_CHERISH, NATURE_JOLLY, 0, MON_MALE, {0, 0, 0, 0, 0, 0}, {31, 31, 31, 31, 31, 31}, {MOVE_TACKLE, MOVE_GROWL, MOVE_TAIL_WHIP, MOVE_THUNDER_SHOCK}, TRUE, TYPE_GHOST, FALSE}, // Electric
    [BALL_TOP_FOURTH]       = {SPECIES_EEVEE, 5, ITEM_FAIRY_GEM, BALL_CHERISH, NATURE_JOLLY, 0, MON_MALE, {0, 0, 0, 0, 0, 0}, {31, 31, 31, 31, 31, 31}, {MOVE_TACKLE, MOVE_GROWL, MOVE_TAIL_WHIP, MOVE_FAIRY_WIND}, TRUE, TYPE_GHOST, FALSE}, // Fairy
    [BALL_MIDDLE_THIRD]     = {SPECIES_EEVEE, 5, ITEM_DARK_GEM, BALL_CHERISH, NATURE_JOLLY, 0, MON_MALE, {0, 0, 0, 0, 0, 0}, {31, 31, 31, 31, 31, 31}, {MOVE_TACKLE, MOVE_GROWL, MOVE_TAIL_WHIP, MOVE_BITE}, TRUE, TYPE_GHOST, FALSE}, // Dark

    [BALL_MIDDLE_SECOND]    = {SPECIES_EEVEE, 5, ITEM_NORMAL_GEM, BALL_CHERISH, NATURE_JOLLY, 0, MON_MALE, {0, 0, 0, 0, 0, 0}, {31, 31, 31, 31, 31, 31}, {MOVE_TACKLE, MOVE_GROWL, MOVE_TAIL_WHIP, MOVE_QUICK_ATTACK}, TRUE, TYPE_GHOST, FALSE}, // Normal
    [BALL_BOTTOM_FIRST]     = {SPECIES_EEVEE, 5, ITEM_GRASS_GEM, BALL_CHERISH, NATURE_JOLLY, 0, MON_MALE, {0, 0, 0, 0, 0, 0}, {31, 31, 31, 31, 31, 31}, {MOVE_TACKLE, MOVE_GROWL, MOVE_TAIL_WHIP, MOVE_LEAFAGE}, TRUE, TYPE_GHOST, FALSE}, // Grass
    [BALL_BOTTOM_SECOND]    = {SPECIES_EEVEE, 5, ITEM_ICE_GEM, BALL_CHERISH, NATURE_JOLLY, 0, MON_MALE, {0, 0, 0, 0, 0, 0}, {31, 31, 31, 31, 31, 31}, {MOVE_TACKLE, MOVE_GROWL, MOVE_TAIL_WHIP, MOVE_POWDER_SNOW}, TRUE, TYPE_GHOST, FALSE}, // Ice
};

...
{
    [BALL_TOP_FIRST]        = {SPECIES_MUDKIP, 5, ITEM_ORAN_BERRY, BALL_PREMIER, NATURE_SERIOUS, 1, MON_MALE, {0, 0, 0, 0, 0, 0}, {31, 31, 31, 31, 31, 31}, {MOVE_WATER_GUN, MOVE_TACKLE, MOVE_GROWL, MOVE_NONE}, 0, TYPE_GROUND, 0},
    [BALL_TOP_SECOND]       = {SPECIES_TREECKO, 5, ITEM_ORAN_BERRY, BALL_PREMIER, NATURE_SERIOUS, 1, MON_MALE, {0, 0, 0, 0, 0, 0}, {31, 31, 31, 31, 31, 31}, {MOVE_LEAFAGE, MOVE_POUND, MOVE_LEER, MOVE_NONE}, 0, TYPE_DRAGON, 0},
    [BALL_MIDDLE_FIRST]     = {SPECIES_TORCHIC, 5, ITEM_ORAN_BERRY, BALL_PREMIER, NATURE_SERIOUS, 1, MON_MALE, {0, 0, 0, 0, 0, 0}, {31, 31, 31, 31, 31, 31}, {MOVE_EMBER, MOVE_SCRATCH, MOVE_GROWL, MOVE_NONE}, 0, TYPE_FIGHTING, 0},

    [BALL_TOP_THIRD]        = {SPECIES_CHIKORITA, 5, ITEM_ORAN_BERRY, BALL_PREMIER, NATURE_SERIOUS, 1, MON_MALE, {0, 0, 0, 0, 0, 0}, {31, 31, 31, 31, 31, 31}, {MOVE_TACKLE, MOVE_GROWL, MOVE_NONE, MOVE_NONE}, 0, TYPE_FAIRY, 0},
    [BALL_TOP_FOURTH]       = {SPECIES_TOTODILE, 5, ITEM_ORAN_BERRY, BALL_PREMIER, NATURE_SERIOUS, 1, MON_MALE, {0, 0, 0, 0, 0, 0}, {31, 31, 31, 31, 31, 31}, {MOVE_SCRATCH, MOVE_LEER, MOVE_NONE, MOVE_NONE}, 0, TYPE_DARK, 0},
    [BALL_MIDDLE_THIRD]     = {SPECIES_CYNDAQUIL, 5, ITEM_ORAN_BERRY, BALL_PREMIER, NATURE_SERIOUS, 1, MON_MALE, {0, 0, 0, 0, 0, 0}, {31, 31, 31, 31, 31, 31}, {MOVE_TACKLE, MOVE_LEER, MOVE_NONE, MOVE_NONE}, 0, TYPE_GHOST, 0},

    [BALL_MIDDLE_SECOND]    = {SPECIES_BULBASAUR, 5, ITEM_ORAN_BERRY, BALL_PREMIER, NATURE_SERIOUS, 1, MON_MALE, {0, 0, 0, 0, 0, 0}, {31, 31, 31, 31, 31, 31}, {MOVE_VINE_WHIP, MOVE_TACKLE, MOVE_GROWL, MOVE_NONE}, 0, TYPE_POISON, 0},
    [BALL_BOTTOM_FIRST]     = {SPECIES_CHARMANDER, 5, ITEM_ORAN_BERRY, BALL_PREMIER, NATURE_SERIOUS, 1, MON_MALE, {0, 0, 0, 0, 0, 0}, {31, 31, 31, 31, 31, 31}, {MOVE_EMBER, MOVE_TACKLE, MOVE_GROWL, MOVE_NONE}, 0, TYPE_DRAGON, 0},
    [BALL_BOTTOM_SECOND]    = {SPECIES_SQUIRTLE, 5, ITEM_ORAN_BERRY, BALL_PREMIER, NATURE_SERIOUS, 1, MON_MALE, {0, 0, 0, 0, 0, 0}, {31, 31, 31, 31, 31, 31}, {MOVE_WATER_GUN, MOVE_TACKLE, MOVE_GROWL, MOVE_NONE}, 0, TYPE_STEEL, 0},
};

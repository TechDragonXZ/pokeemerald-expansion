...
const u8 gText_TerrariumMain[] = _("Terrarium Main");
const u8 gText_TerrariumSub[] = _("Terrarium Sub");
...
const u8 gText_SafariBallAndPrice[] = _("SAFARI BALL{CLEAR_TO 0x48}¥200");
const u8 gText_SportBallAndPrice[] = _("SPORT BALL{CLEAR_TO 0x48}¥300");

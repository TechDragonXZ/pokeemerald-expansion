...
static u32 EvenCraftingUi_GetTotalBagSlots(void)
{
    return BAG_ITEMS_COUNT + BAG_KEYITEMS_COUNT + BAG_POKEBALLS_COUNT + BAG_TMHM_COUNT + BAG_BERRIES_COUNT + BAG_MEDICINE_COUNT + BAG_BATTLEITEMS_COUNT + BAG_MEGASTONES_COUNT + BAG_POKEBALLS_COUNT + BAG_TREASURES_COUNT + BAG_ZCRYSTALS_COUNT;
}

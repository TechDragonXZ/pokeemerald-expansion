...
bool32 IsMoveMakingContact(u32 move, u32 battlerAtk)
{
    ...
    if (!gMovesInfo[move].makesContact)
    {
        if (gMovesInfo[move].effect == EFFECT_SHELL_SIDE_ARM && gBattleStruct->swapDamageCategory)
            return TRUE;
        else if (gMovesInfo[move].effect == EFFECT_DELTA_ENERGY && gBattleStruct->swapDamageCategory)
            return TRUE;
        else
            return FALSE;
    }
...
bool32 IsBattlerProtected(u32 battler, u32 move)
{
    ...
    if (GetBattlerAbility(gBattlerAttacker) == ABILITY_UNSEEN_FIST
        && (gMovesInfo[move].makesContact || (gMovesInfo[move].effect == EFFECT_SHELL_SIDE_ARM && gBattleStruct->swapDamageCategory) || (gMovesInfo[move].effect == EFFECT_DELTA_ENERGY && gBattleStruct->swapDamageCategory))
...
static inline void MulByTypeEffectiveness(uq4_12_t *modifier, u32 move, u32 moveType, u32 battlerDef, u32 defType, u32 battlerAtk, bool32 recordAbilities)
{
    ...
    if (moveType == TYPE_FIRE && gDisableStructs[battlerDef].tarShot)
        mod = UQ_4_12(2.0);
    if (gMovesInfo[move].effect == EFFECT_DELTA_ENERGY) {
    ...
    if (GetBattlerAbility(battlerDef) == ABILITY_VEEVEE_GUARD && (gMovesInfo[move].type == TYPE_WATER || gMovesInfo[move].type == TYPE_FIRE || gMovesInfo[move].type == TYPE_ELECTRIC || gMovesInfo[move].type == TYPE_GRASS || gMovesInfo[move].type == TYPE_ICE || gMovesInfo[move].type == TYPE_DARK || gMovesInfo[move].type == TYPE_PSYCHIC || gMovesInfo[move].type == TYPE_FAIRY || gMovesInfo[move].type == TYPE_NORMAL))
        mod = UQ_4_12(0.5);
...
uq4_12_t CalcTypeEffectivenessMultiplier(u32 move, u32 moveType, u32 battlerAtk, u32 battlerDef, u32 defAbility, bool32 recordAbilities)
{
    ...
    if (move != MOVE_STRUGGLE && moveType != TYPE_MYSTERY)
    {
        ...
        if (gMovesInfo[move].effect == EFFECT_TWO_TYPED_MOVE || gMovesInfo[move].effect == EFFECT_ACC_DOWN_TWO_TYPED || gMovesInfo[move].effect == EFFECT_DISASTER_WARN)

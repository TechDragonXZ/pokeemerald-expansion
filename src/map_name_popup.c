...
static const u8 sRegionMapSectionId_To_PopUpThemeIdMapping[] =
{
    ...
    [MAPSEC_TERRARIUM] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_DREAM_WORLD] = MAPPOPUP_THEME_MARBLE
};
...
static const u8 sRegionMapSectionId_To_PopUpThemeIdMapping_BW[] =
{
    ...
    [MAPSEC_TERRARIUM] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_DREAM_WORLD] = MAPPOPUP_THEME_BW_DEFAULT,
};

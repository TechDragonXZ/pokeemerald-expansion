...
const ALIGNED(4) u8 gBattlePalaceNatureToMoveGroupLikelihood[NUM_NATURES][4] =
{
    ...
    [NATURE_PRIDEFUL]  = PALACE_STYLE(56, 22, 56, 22), // 50%, 50%
    [NATURE_LOWLY]     = PALACE_STYLE(56, 22, 56, 22)  // 50%, 50%
};
...
static const u8 sBattlePalaceNatureToFlavorTextId[NUM_NATURES] =
{
    ...
    [NATURE_PRIDEFUL]  = B_MSG_GLINT_IN_EYE,
    [NATURE_LOWLY]     = B_MSG_EAGER_FOR_MORE,
};

...
// Daycare settings
#define INHERIT_BALL				GEN_LATEST // Starting from gen6, pokemon could inherit pokeballs from their parents
#define INHERIT_IVS 				GEN_LATEST // Starting from gen6, pokemon could inherit 5 IVs from their parents using Destiny Knot
#define INHERIT_NATURE 				GEN_LATEST // Starting from gen6, pokemon could inherit their parent's nature regardless of gender using everstone

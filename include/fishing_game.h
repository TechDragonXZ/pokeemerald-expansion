...
#define FISHING_BAR_BOUNCINESS          1.5  // The greater the number, the less the bar will bounce when it hits the left side. (Decimals are encouraged, as a little goes a long way.)
...
#define FISH_VAR_TREASURE_CHANCE        VAR_TREASURE_CHANCE    // Replace 0 with an unused Var to use it to change the percent chance a random treasure will spawn via scripts.

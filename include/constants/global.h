...
#define BAG_KEYITEMS_COUNT 85
#define BAG_POKEBALLS_COUNT 30
#define BAG_TMHM_COUNT 110
#define BAG_BERRIES_COUNT 70
#define BAG_MEDICINE_COUNT 50 // Needs to reduce used space in SaveBlock1 to properly use.
#define BAG_BATTLEITEMS_COUNT 120 // Needs to reduce used space in SaveBlock1 to properly use.
#define BAG_TREASURES_COUNT 70 // Needs to reduce used space in SaveBlock1 to properly use.
...
#define OPTIONS_BATTLE_SCENE_1X         1

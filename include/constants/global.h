...
#define BAG_MEDICINE_COUNT 30 // Needs to reduce used space in SaveBlock1 to properly use.
#define BAG_BATTLEITEMS_COUNT 30 // Needs to reduce used space in SaveBlock1 to properly use.
#define BAG_TREASURES_COUNT 30 // Needs to reduce used space in SaveBlock1 to properly use.
#define BAG_MEGASTONES_COUNT 50 // Needs to reduce used space in SaveBlock1 to properly use.
#define BAG_ZCRYSTALS_COUNT 40 // Needs to reduce used space in SaveBlock1 to properly use.

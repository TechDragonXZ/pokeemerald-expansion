...
#define VAR_DEXNAV_SPECIES                               0x40B8 // Registered dexnav species
#define VAR_MT_PYRE_STATE                                0x40B9
#define VAR_NEW_MAUVILLE_STATE                           0x40BA
#define VAR_DEXNAV_STEP_COUNTER                          0x40BB // steps for finding hidden pokemon
...
#define VAR_MEGASTONE_COUNT                              0x40DB // Number of Megastones given/recieced Var
#define VAR_Z_CRYSTAL_COUNT                              0x40DC // Number of Z-Crystals given/recieced Var
...
#define VAR_BATTLE_TERRAIN                               0x40E5 // Terrain Var

...
#define VAR_LAST_MADE_SECRET_BASE                        0x404E // Last made Secret Base Var
...
#define VAR_BATTLE_SPEED                                 0x408B // Battle Speed Option Var; 0 = 0x, 1 = 1x, 2 = 2x, 3 = 3x, 4 = 4x
...
#define VAR_BADGES                                       0x40A1 // Badges var
...
#define VAR_STEP_COUNTER                                 0x40DC // DexNav Step Counter Var
...
#define VAR_SKY_BATTLE                                   0x40F7 // Sky Battle Position Var
...
#define VAR_FURFROU_TRIM              0x8014 // Furfrou Trim Var

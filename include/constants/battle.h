...
#define ENCOUNTER_RARE          7
#define ENCOUNTER_TYPES         8
...
// Custom
#define SIDE_STATUS_STEEL_TRAP              (1 << 27)
#define SIDE_STATUS_ASH_CLOUD               (1 << 28)
#define SIDE_STATUS_FROST_SPIKES            (1 << 29)

#define SIDE_STATUS_HAZARDS_ANY    (SIDE_STATUS_SPIKES | SIDE_STATUS_STICKY_WEB | SIDE_STATUS_TOXIC_SPIKES | SIDE_STATUS_STEALTH_ROCK | SIDE_STATUS_STEELSURGE | SIDE_STATUS_STEEL_TRAP | SIDE_STATUS_ASH_CLOUD | SIDE_STATUS_FROST_SPIKES)
...
#define MOVE_EFFECT_GENETIC_BURST       88
#define MOVE_EFFECT_FROSTBURN           89
#define MOVE_EFFECT_ALL_STATS_UP_2      90
#define MOVE_EFFECT_STEEL_TRAP          91
#define MOVE_EFFECT_ASH_CLOUD           92

...
#define MOVE_EFFECT_GENETIC_BURST       87
#define MOVE_EFFECT_FROSTBURN           88
#define MOVE_EFFECT_ALL_STATS_UP_2      89
#define MOVE_EFFECT_STEEL_TRAP          90
#define MOVE_EFFECT_ASH_CLOUD           91

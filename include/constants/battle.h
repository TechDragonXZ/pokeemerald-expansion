...
#define MOVE_EFFECT_GENETIC_BURST       89
#define MOVE_EFFECT_FROSTBURN           90
#define MOVE_EFFECT_ALL_STATS_UP_2      91
#define MOVE_EFFECT_STEEL_TRAP          92
#define MOVE_EFFECT_ASH_CLOUD           93

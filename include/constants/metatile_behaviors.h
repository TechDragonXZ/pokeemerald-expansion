...
#define MB_PACHINKO_MACHINE 0xA1
#define MB_DERBY_MACHINE 0xA2
#define MB_SNAKE_MACHINE 0xA3
#define MB_FLAPPY_BIRD_MACHINE 0xA4
#define MB_BLOCK_STACKER_MACHINE 0xA5
#define MB_VOLTORB_FLIP_TABLE 0xA6
#define MB_BLACKJACK_TABLE 0xA7
...
#define MB_CRAFTING_STATION 0xD7
#define MB_TUTORIAL_STATION 0xD8
#define MB_SELF_TRADE_MACHINE 0xD9

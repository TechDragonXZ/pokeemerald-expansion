...
#define PARTY_MSG_WHICH_OUTFIT              31
#define PARTY_MSG_MOVE_ITEM_WHERE           32
#define PARTY_MSG_WHICH_STATUS              33 // hexorb Branch
#define PARTY_MSG_DO_WHAT_WITH_FOLLOWER     34
...
#define SELECTWINDOW_HEXORB      7 // hexorb Branch
#define SELECTWINDOW_FOLLOWER    8
